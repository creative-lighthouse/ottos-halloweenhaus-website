<% with $Registration %>
    ...
    <body class="ticket">
        <div class="section section--Ticket ticket-page" data-status-url="{$Top.Link}/ticketdata/{$Hash}"></div>
        <script type="application/json" id="ticket-initial-data">$Top.TicketDataJSON.RAW</script>
